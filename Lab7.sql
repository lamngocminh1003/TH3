...
exec sp_InsertHangsx 'H05',N'Xiaomi',N'Trung Quốc','098769007','xiaomivietnam@gmail.com'

---Câu 2---
alter PROCEDURE sp_ThemSuaSanPham
    @masp NVARCHAR(10),
    @mahangsx NVARCHAR(10),
    @tensp NVARCHAR(50),
    @soluong INT,
...
exec sp_ThemSuaSanPham 'SP06','H05',N'Điện thoại',5,'đỏ','8000000','vnđ',N'Điện thoại mới'

---Câu 3---

ALTER PROCEDURE sp_DeleteHangSX
    @tenhang NVARCHAR(50)
AS
BEGIN
    ...
    COMMIT TRANSACTION
END
exec sp_DeleteHangSX 'Apple'
---Câu 4---
alter PROCEDURE sp_NhapNhanVien
    @manv VARCHAR(10),
    @tennv NVARCHAR(50),
    @gioitinh NVARCHAR(3),
    @diachi NVARCHAR(100),
...
ALTER PROCEDURE ThemNhap(@sohdn varchar(20), @masp varchar(20), @manv varchar(20), @ngaynhap date, @soluongN int, @dongiaN float)
AS
BEGIN
...
---Câu 7---
alter PROCEDURE sp_DeleteNhanvien 
    @manv nchar(10)
AS
BEGIN
...
EXEC sp_DeleteNhanvien 'NV02'
select * from Nhanvien
---Câu 8---
alter PROCEDURE sp_DeleteSanpham
  @masp VARCHAR(10)
AS
BEGIN
  SET NOCOUNT ON;
